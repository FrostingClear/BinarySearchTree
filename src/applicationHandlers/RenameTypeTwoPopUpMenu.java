...
import searchUIandHandlers.NameChangeTypeTwo;
 ...
 *
 */
public class RenameTypeTwoPopUpMenu implements EventHandler<ActionEvent> {

	
	BTreeMain main;
	
	public RenameTypeTwoPopUpMenu(BTreeMain main) {
	...
	public void handle(ActionEvent event) {
		...
		Text prompt0 = new Text("Implementation approach #2");
		Text prompt0_1 = new Text("This will REMOVE the node from the binary tree and re-insert it with new name");
		Text prompt0_2 = new Text("Unlike Implementation #1 does not currently rebalance");
		Text prompt0_3 = new Text("But does NOT rely on any companion arraylist");
		...
		submit.setOnAction(new NameChangeTypeTwo(main, IDselector, fnameEntry, lnameEntry, stage, feedback));
		...
		stage.setTitle("Rename Implementation #2");
		stage.show();
